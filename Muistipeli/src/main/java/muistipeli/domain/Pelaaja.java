...
public class Pelaaja implements Comparable<Pelaaja> {
    ...
    /**
     * Konstruktori asettaa alkuarvot Pelaaja-olion atribuuteille.
     * @param nimimerkki luotavan pelaajan nimimerkki
     * @param id luotavan pelaajan id-numero
     */
